...
def git_initialize(repository)
  unless File.exist?(".git")
    ...
    system "git remote add menglifang http://gitlab.menglifang.org/opensource/emberjs-cn.git"
  end
end

def git_update(remote = 'origin')
  system "git fetch #{remote}"
  system "git reset --hard #{remote}/master"
...
def deploy(remote, message)
  ...
  system "git push #{remote} master" unless ENV['NODEPLOY']
end
...
task :deploy do |t, args|
  ...
  Dir.chdir "build" do
    ...
    deploy('origin', message)
    deploy('menglifang', message)
  end
end
